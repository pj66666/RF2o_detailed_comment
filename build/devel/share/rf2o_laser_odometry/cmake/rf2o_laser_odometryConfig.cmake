...
if("TRUE" STREQUAL "TRUE")
  set(rf2o_laser_odometry_SOURCE_PREFIX /home/pj/rf2o_laser_odometry-ros1)
  set(rf2o_laser_odometry_DEVEL_PREFIX /home/pj/rf2o_laser_odometry-ros1/build/devel)
...
if(NOT "/home/pj/rf2o_laser_odometry-ros1/include;/usr/include/eigen3 " STREQUAL " ")
  set(rf2o_laser_odometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/pj/rf2o_laser_odometry-ros1/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rf2o_laser_odometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pj/rf2o_laser_odometry-ros1/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pj/rf2o_laser_odometry-ros1/build/devel/lib;/opt/ros/noetic/lib)
